...
public interface CartApi {
    ...
    ResponseEntity<String> createProductCart(@RequestBody Item item);
    
    @RequestMapping(value = "/api/cart/{customerid}",
            method = RequestMethod.GET)
    ResponseEntity<Collection<Item>> findByCustomerId(@PathVariable("customerid") String customerid);
    

    @RequestMapping(value = "/api/cart/{customerid}",
            method = RequestMethod.DELETE)
    ResponseEntity<String> deletByCustomerId(@PathVariable("customerid") String customerid);
    ...
    @RequestMapping(value = "/api/cart/{customerid}/{itemid}",
    		method = RequestMethod.DELETE)
    		ResponseEntity<String> deletebyItemId(@PathVariable("customerid") String customerid,@PathVariable("itemid") String itemid);
    
    @RequestMapping(value = "/api/cart/ready",
            method = RequestMethod.GET)
